...
class Backend(object):
    ...
    def SaveSimulation(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/backend.Backend/SaveSimulation',
    ...
    def DefineTopographyTemplate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/backend.Backend/DefineTopographyTemplate',
    ...
    def GetTopographyTemplates(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/backend.Backend/GetTopographyTemplates',
