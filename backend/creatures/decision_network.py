...
class SearchForFoodTrigger(TriggerPerceptron):
    def determinePossibility(self, stimuli):
        return (stimuli.energyRatio < 1) and (len(stimuli.immediateResources) == 0)
...
class FleeFromCreatureTrigger(TriggerPerceptron):
    def determinePossibility(self, stimuli):
        return (len(stimuli.perceivablePredators) > 0) or (len(stimuli.immediatePredators) > 0)


class ChaseCreatureTrigger(TriggerPerceptron):
    def determinePossibility(self, stimuli):
        return (len(stimuli.perceivablePrey) > 0) or (len(stimuli.immediatePrey) > 0)
...
class EvadeHostTrigger(TriggerPerceptron):
    def determinePossibility(self, stimuli):
        return (len(stimuli.immediateHosts) > 0) or (len(stimuli.perceivableHosts) > 0)
...
class EvadeParasiteTrigger(TriggerPerceptron):
    def determinePossibility(self, stimuli):
        return (len(stimuli.immediateParasites) > 0) or (len(stimuli.perceivableParasites) > 0)


class ProtectCreatureTrigger(TriggerPerceptron):
    def determinePossibility(self, stimuli):
        return ((len(stimuli.perceivablePredators) > 0) or (len(stimuli.immediatePredators) > 0)) \
            and (len(stimuli.immediateDefendees) > 0)
...
class SexualReproductionPerceptron(ActionPerceptron):
    def getEnvironmentalFavorability(
        ...
        healthRatioWeight = _determine_trait_weight_from_priority(2, numberOfPositiveFactors)
        energyRatioWeight = _determine_trait_weight_from_priority(3, numberOfPositiveFactors)
        immediateMatesWeight = _determine_trait_weight_from_priority(1, numberOfPositiveFactors)
        perceivableAlliesWeight = _determine_trait_weight_from_priority(7, numberOfPositiveFactors)
        immediateAlliesWeight = _determine_trait_weight_from_priority(5, numberOfPositiveFactors)
        perceivableDefendersWeight = _determine_trait_weight_from_priority(6, numberOfPositiveFactors)
        immediateDefendersWeight = _determine_trait_weight_from_priority(4, numberOfPositiveFactors)

        numberOfNegativeFactors = 5
        ageRatioWeight = -1 * _determine_trait_weight_from_priority(5, numberOfNegativeFactors)
        perceivablePredatorsWeight = -1 * _determine_trait_weight_from_priority(3, numberOfNegativeFactors)
        immediatePredatorsWeight = -1 * _determine_trait_weight_from_priority(1, numberOfNegativeFactors)
        perceivableCompetitorsWeight = -1 * _determine_trait_weight_from_priority(4, numberOfNegativeFactors)
        immediateCompetitorsWeight = -1 * _determine_trait_weight_from_priority(2, numberOfNegativeFactors)
...
class AsexualReproductionPerceptron(ActionPerceptron):
    def getEnvironmentalFavorability(
        ...
        healthRatioWeight = _determine_trait_weight_from_priority(1, numberOfPositiveFactors)
        energyRatioWeight = _determine_trait_weight_from_priority(2, numberOfPositiveFactors)
        perceivableAlliesWeight = _determine_trait_weight_from_priority(6, numberOfPositiveFactors)
        immediateAlliesWeight = _determine_trait_weight_from_priority(4, numberOfPositiveFactors)
        perceivableDefendersWeight = _determine_trait_weight_from_priority(5, numberOfPositiveFactors)
        immediateDefendersWeight = _determine_trait_weight_from_priority(3, numberOfPositiveFactors)
...
class SearchForResourcesPerceptron(ActionPerceptron):
    def getEnvironmentalFavorability(
        ...
        perceivableResourcesWeight = _determine_trait_weight_from_priority(1, numberOfPositiveFactors)
        perceivableAlliesWeight = _determine_trait_weight_from_priority(5, numberOfPositiveFactors)
        immediateAlliesWeight = _determine_trait_weight_from_priority(3, numberOfPositiveFactors)
        perceivableDefendersWeight = _determine_trait_weight_from_priority(4, numberOfPositiveFactors)
        immediateDefendersWeight = _determine_trait_weight_from_priority(2, numberOfPositiveFactors)

        numberOfNegativeFactors = 4
        healthRatioWeight = -1 * _determine_trait_weight_from_priority(2, numberOfNegativeFactors)
        energyRatioWeight = -1 * _determine_trait_weight_from_priority(4, numberOfNegativeFactors)
        perceivablePredatorsWeight = -1 * _determine_trait_weight_from_priority(3, numberOfNegativeFactors)
        immediatePredatorsWeight = -1 * _determine_trait_weight_from_priority(1, numberOfNegativeFactors)
...
class ConsumeResourcesPerceptron(ActionPerceptron):
    def getEnvironmentalFavorability(
            ...
            stimuli):
        numberOfPositiveFactors = 7
        immediateResourcesWeight = _determine_trait_weight_from_priority(1, numberOfPositiveFactors)
        perceivableCompetitorsWeight = _determine_trait_weight_from_priority(7, numberOfPositiveFactors)
        immediateCompetitorsWeight = _determine_trait_weight_from_priority(6, numberOfPositiveFactors)
        perceivableAlliesWeight = _determine_trait_weight_from_priority(5, numberOfPositiveFactors)
        immediateAlliesWeight = _determine_trait_weight_from_priority(3, numberOfPositiveFactors)
        perceivableDefendersWeight = _determine_trait_weight_from_priority(4, numberOfPositiveFactors)
        immediateDefendersWeight = _determine_trait_weight_from_priority(2, numberOfPositiveFactors)
        ...
        numberOfNegativeFactors = 4
        healthRatioWeight = -1 * _determine_trait_weight_from_priority(4, numberOfNegativeFactors)
        energyRatioWeight = -1 * _determine_trait_weight_from_priority(3, numberOfNegativeFactors)
        perceivablePredatorsWeight = -1 * _determine_trait_weight_from_priority(2, numberOfNegativeFactors)
        immediatePredatorsWeight = -1 * _determine_trait_weight_from_priority(1, numberOfNegativeFactors)
...
class SearchForMatePerceptron(ActionPerceptron):
    def getEnvironmentalFavorability(
        ...
        healthRatioWeight = _determine_trait_weight_from_priority(1, numberOfPositiveFactors)
        energyRatioWeight = _determine_trait_weight_from_priority(2, numberOfPositiveFactors)
        perceivableMatesWeight = _determine_trait_weight_from_priority(3, numberOfPositiveFactors)
...
class FleeFromCreaturePerceptron(ActionPerceptron):
    def getEnvironmentalFavorability(
        ...
        energyRatioWeight = _determine_trait_weight_from_priority(3, numberOfPostiveFactors)
        ageRatioWeight = _determine_trait_weight_from_priority(4, numberOfPostiveFactors)
        perceivablePredatorsWeight = _determine_trait_weight_from_priority(2, numberOfPostiveFactors)
        immediatePredatorsWeight = _determine_trait_weight_from_priority(1, numberOfPostiveFactors)

        numberOfNegativeFactors = 5
        healthRatioWeight = -1 * _determine_trait_weight_from_priority(5, numberOfNegativeFactors)
        perceivableAlliesWeight = -1 * _determine_trait_weight_from_priority(4, numberOfNegativeFactors)
        immediateAlliesWeight = -1 * _determine_trait_weight_from_priority(2, numberOfNegativeFactors)
        perceivableDefendersWeight = -1 * _determine_trait_weight_from_priority(3, numberOfNegativeFactors)
        immediateDefendersWeight = -1 * _determine_trait_weight_from_priority(1, numberOfNegativeFactors)
...
class ChaseACreaturePerceptron(ActionPerceptron):
    def getEnvironmentalFavorability(
            ...
            stimuli):
        numberOfPositiveFactors = 6
        energyRatioWeight = _determine_trait_weight_from_priority(4, numberOfPositiveFactors)
        perceivablePreyWeight = _determine_trait_weight_from_priority(1, numberOfPositiveFactors)
        perceivableAlliesWeight = _determine_trait_weight_from_priority(5, numberOfPositiveFactors)
        immediateAlliesWeight = _determine_trait_weight_from_priority(2, numberOfPositiveFactors)
        perceivableDefendersWeight = _determine_trait_weight_from_priority(6, numberOfPositiveFactors)
        immediateDefendersWeight = _determine_trait_weight_from_priority(3, numberOfPositiveFactors)

        numberOfNegativeFactors = 3
        ageRatioWeight = -1 * _determine_trait_weight_from_priority(3, numberOfNegativeFactors)
        perceivablePredatorsWeight = -1 * _determine_trait_weight_from_priority(2, numberOfNegativeFactors)
        immediatePredatorsWeight = -1 * _determine_trait_weight_from_priority(1, numberOfNegativeFactors)
...
class AttackCreaturePerceptron(ActionPerceptron):
    def getEnvironmentalFavorability(self, stimuli):
        ...
        healthRatioWeight = _determine_trait_weight_from_priority(5, numberOfPositiveFactors)
        energyRatioWeight = _determine_trait_weight_from_priority(6, numberOfPositiveFactors)
        immediatePreyWeight = _determine_trait_weight_from_priority(1, numberOfPositiveFactors)
        immediateCompetitorWeight = _determine_trait_weight_from_priority(4, numberOfPositiveFactors)
        perceivableAlliesWeight = _determine_trait_weight_from_priority(8, numberOfPositiveFactors)
        immediateAlliesWeight = _determine_trait_weight_from_priority(3, numberOfPositiveFactors)
        perceivableDefendersWeight = _determine_trait_weight_from_priority(7, numberOfPositiveFactors)
        immediateDefendersWeight = _determine_trait_weight_from_priority(2, numberOfPositiveFactors)
    ...
    def determineActivation(self, environmentalFavorability, creatureGenome):
        activation = _skew_positive(creatureGenome.territorial, environmentalFavorability, 0.5)
...
class SeekAlliesPerceptron(ActionPerceptron):
    def getEnvironmentalFavorability(self, stimuli):
        ...
        perceivableAlliesWeight = _determine_trait_weight_from_priority(2, numberOfPositiveFactors)
        immediateAlliesWeight = _determine_trait_weight_from_priority(1, numberOfPositiveFactors)
    ...
    def determineActivation(self, environmentalFavorability, creatureGenome):
        ...
        activation = _skew_negative(creatureGenome.individualism, activation, 0.5)
...
class LeechOffCreaturePerceptron(ActionPerceptron):
    ...
    def determineActivation(self, environmentalFavorability, creatureGenome):
        activation = _skew_positive(creatureGenome.effectFromHost, environmentalFavorability, 0.5)
...
class EvadeHostPerceptron(ActionPerceptron):
    def getEnvironmentalFavorability(self, stimuli):
        numberOfPositiveFactors = 2
        perceivableHostsWeight = _determine_trait_weight_from_priority(2, numberOfPositiveFactors)
        immediateHostsWeight = _determine_trait_weight_from_priority(1, numberOfPositiveFactors)
    ...
    def determineActivation(self, environmentalFavorability, creatureGenome):
        activation = _skew_negative(creatureGenome.effectFromHost, environmentalFavorability, 0.5)
...
class SeekParasitePerceptron(ActionPerceptron):
    ...
    def determineActivation(self, environmentalFavorability, creatureGenome):
        activation = _skew_positive(creatureGenome.effectFromParasite, environmentalFavorability, 0.5)
...
class EvadeParasitePerceptron(ActionPerceptron):
    def getEnvironmentalFavorability(self, stimuli):
        numberOfPositiveFactors = 2
        perceivableParasitesWeight = _determine_trait_weight_from_priority(2, numberOfPositiveFactors)
        immediateParasitesWeight = _determine_trait_weight_from_priority(1, numberOfPositiveFactors)
    ...
    def determineActivation(self, environmentalFavorability, creatureGenome):
        activation = _skew_negative(creatureGenome.effectFromParasite, environmentalFavorability, 0.5)
...
class ProtectCreaturePerceptron(ActionPerceptron):
    def getEnvironmentalFavorability(self, stimuli):
        ...
        healthRatioWeight = _determine_trait_weight_from_priority(2, numberOfPositiveFactors)
        energyRatioWeight = _determine_trait_weight_from_priority(3, numberOfPositiveFactors)
        immediateDefendeesWeight = _determine_trait_weight_from_priority(1, numberOfPositiveFactors)
...
class SeekDefendeePerceptron(ActionPerceptron):
    def getEnvironmentalFavorability(self, stimuli):
        ...
        healthRatioWeight = _determine_trait_weight_from_priority(2, numberOfPositiveFactors)
        energyRatioWeight = _determine_trait_weight_from_priority(3, numberOfPositiveFactors)
        perceivableDefendeesWeight = _determine_trait_weight_from_priority(1, numberOfPositiveFactors)
...
class SeekDefenderPerceptron(ActionPerceptron):
    def getEnvironmentalFavorability(self, stimuli):
        ...
        perceivablePredatorsWeight = _determine_trait_weight_from_priority(3, numberOfPositiveFactors)
        immediatePredatorsWeight = _determine_trait_weight_from_priority(2, numberOfPositiveFactors)
        perceivableDefendersWeight = _determine_trait_weight_from_priority(1, numberOfPositiveFactors)
        immediateDefendersWeight = _determine_trait_weight_from_priority(4, numberOfPositiveFactors)

        numberOfNegativeFactors = 4
        healthRatioWeight = -1 * _determine_trait_weight_from_priority(1, numberOfNegativeFactors)
        energyRatioWeight = -1 * _determine_trait_weight_from_priority(2, numberOfNegativeFactors)
        perceivableAlliesWeight = -1 * _determine_trait_weight_from_priority(4, numberOfNegativeFactors)
        immediateAlliesWeight = -1 * _determine_trait_weight_from_priority(3, numberOfNegativeFactors)
...
class NurtureCreaturePerceptron(ActionPerceptron):
    def getEnvironmentalFavorability(self, stimuli):
        ...
        perceivableDefendersWeight = _determine_trait_weight_from_priority(6, numberOfPositiveFactors)
        immediateDefendersWeight = _determine_trait_weight_from_priority(4, numberOfPositiveFactors)
        immediateNurtureesWeight = _determine_trait_weight_from_priority(1, numberOfPositiveFactors)
    ...
    def determineActivation(self, environmentalFavorability, creatureGenome):
        activation = _skew_negative(creatureGenome.selfPreservation, environmentalFavorability, 0.5)
        activation = _skew_negative(creatureGenome.individualism, activation, 0.5)
        activation = _skew_negative(creatureGenome.territorial, activation, 0.5)
        activation = _skew_negative(creatureGenome.hostility, activation, 0.5)
        activation = _skew_positive(creatureGenome.offensiveAbility, activation, 0.5)
        activation = _skew_positive(creatureGenome.defensiveAbility, activation, 0.5)
...
class SeekNurtureePerceptron(ActionPerceptron):
    def getEnvironmentalFavorability(self, stimuli):
        ...
        perceivableDefendersWeight = _determine_trait_weight_from_priority(6, numberOfPositiveFactors)
        immediateDefendersWeight = _determine_trait_weight_from_priority(4, numberOfPositiveFactors)
        perceivableNurtureesWeight = _determine_trait_weight_from_priority(1, numberOfPositiveFactors)
...
class SeekNurturerPerceptron(ActionPerceptron):
    def getEnvironmentalFavorability(self, stimuli):
        numberOfPositiveFactors = 4
        perceivablePredatorsWeight = _determine_trait_weight_from_priority(4, numberOfPositiveFactors)
        immediatePredatorsWeight = _determine_trait_weight_from_priority(2, numberOfPositiveFactors)
        perceivableNurturersWeight = _determine_trait_weight_from_priority(3, numberOfPositiveFactors)
        immediateNurturersWeight = _determine_trait_weight_from_priority(1, numberOfPositiveFactors)

        numberOfNegativeFactors = 6
        healthRatioWeight = -1 * _determine_trait_weight_from_priority(1, numberOfNegativeFactors)
        energyRatioWeight = -1 * _determine_trait_weight_from_priority(2, numberOfNegativeFactors)
        perceivableAlliesWeight = -1 * _determine_trait_weight_from_priority(6, numberOfNegativeFactors)
        immediateAlliesWeight = -1 * _determine_trait_weight_from_priority(4, numberOfNegativeFactors)
        perceivableDefendersWeight = -1 * _determine_trait_weight_from_priority(5, numberOfNegativeFactors)
        immediateDefendersWeight = -1 * _determine_trait_weight_from_priority(3, numberOfNegativeFactors)
    ...
    def determineActivation(self, environmentalFavorability, creatureGenome):
        ...
        activation = _skew_negative(creatureGenome.defensiveAbility, activation, 0.5)
        activation = _skew_positive(creatureGenome.effectFromBeingNurtured, activation, 0.5)
...
def _seperate_immediate_objects(objects, centralObject):
    ...
    for object in objects:
        if abs(math.dist([object.xCoordinate, object.yCoordinate], [centralObject.xCoordinate, centralObject.yCoordinate])) <= UNIT:
...
def _cast_to_stimuli(creatureOfInterest, perceivableEnvironment):
    ...
    [immediateMates, perceivableMates] = _seperate_immediate_objects(perceivableEnvironment.perceivableMates, creatureOfInterest)
    [immediateResources, perceivableResources] = _seperate_immediate_objects(perceivableEnvironment.perceivableResources, creatureOfInterest)
    [immediatePredators, perceivablePredators] = _seperate_immediate_objects(perceivableEnvironment.perceivablePredators, creatureOfInterest)
    [immediatePrey, perceivablePrey] = _seperate_immediate_objects(perceivableEnvironment.perceivablePrey, creatureOfInterest)
    [immediateCompetitors, perceivableCompetitors] = _seperate_immediate_objects(perceivableEnvironment.perceivableCompetitors, creatureOfInterest)
    [immediateAllies, perceivableAllies] = _seperate_immediate_objects(perceivableEnvironment.perceivableAllies, creatureOfInterest)
    [immediateDefenders, perceivableDefenders] = _seperate_immediate_objects(perceivableEnvironment.perceivableDefenders, creatureOfInterest)
    [immediateDefendees, perceivableDefendees] = _seperate_immediate_objects(perceivableEnvironment.perceivableDefendees, creatureOfInterest)
    [immediateParasites, perceivableParasites] = _seperate_immediate_objects(perceivableEnvironment.perceivableParasites, creatureOfInterest)
    [immediateHosts, perceivableHosts] = _seperate_immediate_objects(perceivableEnvironment.perceivableHosts, creatureOfInterest)
    [immediateNurturers, perceivableNurturers] = _seperate_immediate_objects(perceivableEnvironment.perceivableNurturers, creatureOfInterest)
    [immediateNurturees, perceivableNurturees] = _seperate_immediate_objects(perceivableEnvironment.perceivableNurturees, creatureOfInterest)
    ...
    def determineMostFavorableCreatureAction(
        ...
        for action in self.actionNodes:
            if action.actionType in activatedTriggerNodes:
                environmentalFavorability = action.getEnvironmentalFavorability(stimuli)
                activationValues.append(action.determineActivation(environmentalFavorability, creatureOfInterest.genome))
        
        # Recall a past similar event
        similarMemories = creatureOfInterest.memory.searchForResponseToSimilarSituation(stimuli, tolerance=(1 - creatureOfInterest.genome.shortTermMemoryAccuracy))
        beneficialMemory = None
        for memory in similarMemories:
            if memory.netActionBenefit.netGain() > (creatureOfInterest.genome.impulsivity * 2):
                beneficialMemory = memory
                break
        
        if beneficialMemory == None:
