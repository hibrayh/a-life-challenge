...
class Serializer:
    ...
    def iter_unsigners(
            self,
            salt: _t_opt_str_bytes = None) -> _t.Iterator[Signer]:
    ...
    def dumps(
            self,
            obj: _t.Any,
            salt: _t_opt_str_bytes = None) -> _t_str_bytes:
    ...
    def dump(
            ...
            obj: _t.Any,
            f: _t.IO,
            salt: _t_opt_str_bytes = None) -> None:
    ...
    def load_unsafe(
            self,
            f: _t.IO,
            salt: _t_opt_str_bytes = None) -> _t_load_unsafe:
