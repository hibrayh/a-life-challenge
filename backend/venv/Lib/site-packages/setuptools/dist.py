...
=======
        # Save the original dependencies before they are processed into the egg
        # format
>>>>>>> 715a82f0730e45da36532e81a184640e814dd5bb
...
=======
        if getattr(
            self,
            'install_requires',
                None) and not self._orig_install_requires:
...
=======
            self.packages = [p for p in self.packages if p !=
                             package and not p.startswith(pfx)]
