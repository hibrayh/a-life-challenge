...
=======
        options = (opt[:2]
                   for opt in setuptools.dist.Distribution.global_options)
        return {
            flag for long_and_short in options for flag in long_and_short if flag}
>>>>>>> 715a82f0730e45da36532e81a184640e814dd5bb
...
=======
    def __dist_info_args(
            self,
            config_settings: _ConfigSettings) -> Iterator[str]:
>>>>>>> 715a82f0730e45da36532e81a184640e814dd5bb
        """
...
=======
    def _get_dist_info_dir(
            self,
            metadata_directory: Optional[str]) -> Optional[str]:
        if not metadata_directory:
            return None
