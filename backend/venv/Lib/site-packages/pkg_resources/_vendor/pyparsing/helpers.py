...
=======
                # symbols are just single characters, create range regex
                # pattern
>>>>>>> 715a82f0730e45da36532e81a184640e814dd5bb
                patt = "[{}]".format(
...
=======
            ...
            Opt(
                "/",
                default=[False])("empty").set_parse_action(
                lambda s,
                l,
                t: t[0] == "/") +
            suppress_GT)
        ...
        tagAttrValue = quoted_string.copy().set_parse_action(
            remove_quotes) | Word(printables, exclude_chars=">")
>>>>>>> 715a82f0730e45da36532e81a184640e814dd5bb
        openTag = (
            suppress_LT
            + tagStr("tag")
...
=======
InfixNotationOperatorArgType = Union[ParserElement, str,
...
=======
    INDENT = (
        Empty() +
        Empty().set_parse_action(checkSubIndent)).set_name("INDENT")
>>>>>>> 715a82f0730e45da36532e81a184640e814dd5bb
