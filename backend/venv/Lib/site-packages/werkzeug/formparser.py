...
=======
    def get_parse_func(self,
                       mimetype: str,
                       options: t.Dict[str,
                                       str]) -> t.Optional[t.Callable[["FormDataParser",
                                                                       t.IO[bytes],
                                                                       str,
                                                                       t.Optional[int],
                                                                       t.Dict[str,
...
=======
            # if the input stream is not exhausted, firefox reports Connection
            # Reset
>>>>>>> 715a82f0730e45da36532e81a184640e814dd5bb
            _exhaust(stream)
...
=======
                return parse_func(
                    self, stream, mimetype, content_length, options)
>>>>>>> 715a82f0730e45da36532e81a184640e814dd5bb
            except ValueError:
                if not self.silent:
                    raise
...
=======
    ...
    #: mapping of mimetypes to parsing functions
    parse_functions: t.Dict[str,
                            t.Callable[["FormDataParser",
                                        t.IO[bytes],
                                        str,
                                        t.Optional[int],
                                        t.Dict[str,
