...
=======
        return [rule for rules in self._rules_by_endpoint.values()
                for rule in rules]
...
=======
                    f" server name {server_name!r}", stacklevel=2, )
>>>>>>> 715a82f0730e45da36532e81a184640e814dd5bb
                subdomain = "<invalid>"
            else:
...
=======
    def allowed_methods(
            self,
            path_info: t.Optional[str] = None) -> t.Iterable[str]:
>>>>>>> 715a82f0730e45da36532e81a184640e814dd5bb
...
=======
            if r.provides_defaults_for(
                    rule) and r.suitable_for(values, method):
                values.update(r.defaults)  # type: ignore
                domain_part, path = r.build(values)  # type: ignore
    ...
    def encode_query_args(
            self, query_args: t.Union[t.Mapping[str, t.Any], str]) -> str:
>>>>>>> 715a82f0730e45da36532e81a184640e814dd5bb
