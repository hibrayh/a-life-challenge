...
class _TestCookieHeaders:
    ...
    def __init__(
            self, headers: t.Union[Headers, t.List[t.Tuple[str, str]]]) -> None:
...
class EnvironBuilder:
    ...
    def _add_file_from_data(self,
                            key: str,
                            value: t.Union[t.IO[bytes],
                                           t.Tuple[t.IO[bytes],
                                                   str],
                                           t.Tuple[t.IO[bytes],
                                                   str,
    ...
    def _get_form(
            self,
            name: str,
            storage: t.Type[_TAnyMultiDict]) -> _TAnyMultiDict:
    ...
    def get_environ(self) -> "WSGIEnvironment":
        ...
        if input_stream is not None:
            ...
            form_encoded = url_encode(
                self.form, charset=self.charset).encode("ascii")
