...
=======
                parts["query_string"] = environ.get(
                    "QUERY_STRING", "").encode("latin1")
...
=======
def get_host(environ: "WSGIEnvironment",
             trusted_hosts: t.Optional[t.Iterable[str]] = None) -> str:
>>>>>>> 715a82f0730e45da36532e81a184640e814dd5bb
...
=======
    return _to_str(
        ...
        charset,
        errors,
        allow_none_charset=True)  # type: ignore
>>>>>>> 715a82f0730e45da36532e81a184640e814dd5bb
...
=======
        environ_or_baseurl = get_current_url(
            environ_or_baseurl, root_only=True)
>>>>>>> 715a82f0730e45da36532e81a184640e814dd5bb
...
=======
        if not (base_scheme in ("http", "https")
...
=======
            hasattr(
                iterable,
                "seekable") and iterable.seekable()  # type: ignore
>>>>>>> 715a82f0730e45da36532e81a184640e814dd5bb
        )
