...
def parse_dict_header(
        value: str, cls: t.Type[dict] = dict) -> t.Dict[str, str]:
...
def parse_options_header(
        value: t.Optional[str]) -> t.Tuple[str, t.Dict[str, str]]:
...
def parse_www_authenticate_header(
    ...
    return ds.WWWAuthenticate(
        auth_type,
        parse_dict_header(auth_info),
        on_update)
...
def dump_age(age: t.Optional[t.Union[timedelta, int]]
             = None) -> t.Optional[str]:
...
def dump_cookie(
    ...
    if max_size and cookie_size > max_size:
        ...
        warnings.warn(
            ...
            f" silently ignore cookies larger than this.", stacklevel=2, )
