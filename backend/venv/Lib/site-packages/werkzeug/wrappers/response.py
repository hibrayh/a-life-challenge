...
class Response(_SansIOResponse):
    ...
    def __init__(self,
                 response: t.Optional[t.Union[t.Iterable[bytes],
                                              bytes,
                                              t.Iterable[str],
                                              str]] = None,
                 status: t.Optional[t.Union[int,
                                            str,
                                            HTTPStatus]] = None,
                 headers: t.Optional[t.Union[t.Mapping[str,
                                                       t.Union[str,
                                                               int,
                                                               t.Iterable[t.Union[str,
                                                                                  int]]]],
    ...
    def force_type(
            cls,
            response: "Response",
            environ: t.Optional["WSGIEnvironment"] = None) -> "Response":
    ...
    def get_wsgi_headers(self, environ: "WSGIEnvironment") -> Headers:
        ...
        if (
            ...
            try:
                content_length = sum(len(_to_bytes(x, "ascii"))
    ...
    def get_json(self, force: bool = False,
                 silent: bool = False) -> t.Optional[t.Any]:
