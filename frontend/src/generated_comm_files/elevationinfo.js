...
goog.provide('proto.backend.ElevationInfo');
 ...
 * @const
 */
proto.backend.ElevationInfo.repeatedFields_ = [2];
...
proto.backend.ElevationInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    elevationList: (f = jspb.Message.getRepeatedField(msg, 2)) == null ? undefined : f
  };
 ...
 * @return {number}
 */
proto.backend.ElevationInfo.prototype.getId = function() {
 ...
 */
proto.backend.ElevationInfo.prototype.setId = function(value) {
 ...
 * @return {!proto.backend.ElevationInfo} returns this
 */
proto.backend.ElevationInfo.prototype.addElevation = function(value, opt_index) {
