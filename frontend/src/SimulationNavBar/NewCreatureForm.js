        ...
        return(
            <div id="newCreatureForm">
                ...
                <form id="newCreatureData">
                    ...
                    <input onChange={(event) => setCanSee(event.target.value)} type="checkbox"></input><br></br>

                    <span className="dataTitle">Can Smell?</span>
                    <input onChange={(event) => setCanSmell(event.target.value)} type="checkbox"></input><br></br>

                    <span className="dataTitle">Can Hear?</span>
                    <input onChange={(event) => setCanHear(event.target.value)} type="checkbox"></input><br></br>
                    ...
                    <button id="submitButton" onClick={handleSubmit}>Create</button>
